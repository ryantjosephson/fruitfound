	...
	<div class="maincontent">
		...
		?>
				...
				<form method="POST" action="signuphandler.php">
					...
					<div class="newuserdiv"> Username: &#40;Must Must be at least 5 characters long, alphanumeric&#41;</br> <input type="text" id="username" name="username" pattern="\[^A-Za-z0-9_@\.]|@{2,}|\.{5,}"> </div>
					<div class="newuserdiv"> Password: &#40;Must contain one uppercase, one lowercase and one number, no special characters and 8+ digits long&#41;</br> <input type="text" id="password" name="password" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{8,}$"> </div>
