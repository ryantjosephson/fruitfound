...
<html>
	...
	<p>Add your Location</p>
 		 ...
 		 <form method="POST" action="addlocationhandler.php">
			...
			<div class="newuserdiv"> City:</br> <input type="text" id="city" name="city" value="<?php echo$location['City'];?>" pattern="> </div>
			<div class="newuserdiv"> State:</br> <input type="text" id="state" name="state" value="<?php echo$location['State'];?>" pattern="[a-Aa-z]{0,12}"> </div>
			<div class="newuserdiv"> Zip:</br> <input type="text" id="zip" name="zip" value="<?php echo$location['Zip'];?>" pattern="(\d{5}([\-]\d{4})?)"> </div>
			<div class="newuserdiv"> Phone:</br> <input type="text" id="phone" name="phone" value="<?php echo $location['Phone'];?>" pattern="\d{3}[?\-]\d{3}[?\-]\d{4}> </div>
